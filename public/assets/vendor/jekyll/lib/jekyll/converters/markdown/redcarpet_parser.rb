      ...
      class RedcarpetParser
        ...
        module CommonMethods
          def add_code_tags(code, lang)
            code = code.to_s
            code = code.sub(/<pre>/, "<pre><code className=\"language-#{lang}\" data-lang=\"#{lang}\">")
        ...
        module WithoutHighlighting
          ...
          def code_wrap(code)
            "<div className=\"highlight\"><pre>#{CGI::escapeHTML(code)}</pre></div>"
          end
        ...
        module WithRouge
          def block_code(code, lang)
            ...
            output = "<div className=\"highlight\">"
