Feature: Collections
  ...
  Scenario: Rendered document in a layout
    Given I have an "index.html" page that contains "Collections: {{ site.collections }}"
    And I have a default layout that contains "<div className='title'>Tom Preston-Werner</div> {{content}}"
    And I have fixture collections
    And I have a "_config.yml" file with content:
    """
    collections:
    ...
    And I should see "<div className='title'>Tom Preston-Werner</div>" in "_site/methods/site/generate.html"
