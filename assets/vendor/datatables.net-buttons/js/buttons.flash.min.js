    ...
    function w(a) {
        ...
        version: "1.0.4-TableTools2", clients: {}, moviePath: "", nextId: 1, $: function (a) {
            "string" == typeof a && (a = l.getElementById(a)); a.addClass || (a.hide = function () { this.style.display = "none" }, a.show = function () {
                this.style.display =
                    ""
            }, a.addclassName = function (a) { this.removeClass(a); this.className += " " + a }, a.removeclassName = function (a) { this.className = this.className.replace(RegExp("\\s*" + a + "\\s*"), " ").replace(/^\s+/, "").replace(/\s+$/, "") }, a.hasclassName = function (a) { return !!this.className.match(RegExp("\\s*" + a + "\\s*")) }); return a
